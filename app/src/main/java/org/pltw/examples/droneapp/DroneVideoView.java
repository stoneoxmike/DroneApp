...
/**
 * Created by MGeyer on 5/5/2017.
 */

public class DroneVideoView extends SurfaceView implements SurfaceHolder.Callback {
    private static final String TAG = "DroneVideoView";
    ...
    public DroneVideoView(Context context) {
        super(context);
        customInit();
    }

    public DroneVideoView(Context context, AttributeSet attrs) {
        super(context, attrs);
        customInit();
    }

    public DroneVideoView(Context context, AttributeSet attrs, int defStyleAttr) {
